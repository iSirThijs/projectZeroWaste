...
async function getCategoriesData() {
	let amsterdam = await area.getAMS();

	


	let sum = compute.sumDatasets.days(amsterdam.computations);
	let averagesKM2 = compute.averages.km2(sum, amsterdam.m2);
	let categories = compute.sumDatasets.categories(amsterdam.computations);
	...
	amsterdam.computations.push(newComputation);
	return amsterdam;
}
...
module.exports = {
	...
	amsBarChartData: getCategoriesData
};
